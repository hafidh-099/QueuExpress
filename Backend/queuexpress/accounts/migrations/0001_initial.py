    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_id', models.CharField(blank=True, help_text='Unique work ID for staff login (null for admin)', max_length=50, null=True, unique=True)),
                ('role', models.CharField(choices=[('admin', 'Admin'), ('staff', 'Staff')], default='staff', max_length=10)),
                ('profile_image', models.ImageField(blank=True, help_text='Profile image for staff members', null=True, upload_to='staff/')),
